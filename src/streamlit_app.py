...
def main():
    ...
    resume = st.file_uploader(
        "Upload Word Doc. resume:", accept_multiple_files=False, type=["docx"]
    )
    ...
    select = st.selectbox(
        "What would you like to check in this job description:",
    ...
    job_url = st.text_input(
        "Job Posting url",
        help="Make sure you link the url to the exact page of the job posting. I.e. not a related link to the posting",
        key="url",
    )
